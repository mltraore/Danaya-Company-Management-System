...
public class Accountant extends  Finances<Accountant> {

	@Override
	public void Record(Accountant c) throws Exception {
				
		Dataccess da = Dataccess.getDataccess();
		String query = " insert into accountant(tc,name,surname,gender,post,department,cell,email,password,startDate,salary)"
	...
	public int Update(Accountant c) throws Exception {
...
public int  Delete(int id) throws  Exception{
		...
		Dataccess da = Dataccess.getDataccess();
		String query = "delete from account where  tc = " + id;
		return  da.ExecuteUpdate(query);
	...
	public ResultSet SearchByName(String name) throws Exception{
		...
		Dataccess da = Dataccess.getDataccess();
		String search = "select *from account where name = " + name;
		return da.ExecuteQuery(search);
	};
	public Boolean Login(Accountant c) throws Exception{
		
		Dataccess da = Dataccess.getDataccess();
		String query = "select id from accountant where email = '"+c.getEmail()+"' and password= '"+c.getPassword()+"'";
